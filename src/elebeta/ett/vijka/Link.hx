...
class Link {
	...
	public
	var startNodeId:Int; // Node::id
	
	public
	var finishNodeId:Int; // Node::id
	
	public
	var extension:Float;
	
	public
	var typeId:Int; // LinkType::id
	...
	function makeEmpty():Link {
		return new Link();
	}

	public static inline
	function make( id, startNodeId, finishNodeId, extension, typeId, toll ):Link {
		var link = new Link();
		link.id = id;
	...
	public static
	function ettFields():Array<Field> {
		return [
			new Field( "id", TInt ),
