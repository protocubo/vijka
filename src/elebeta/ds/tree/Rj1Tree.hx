package elebeta.ds.tree;

private class RevIntIterator {
...
class Rj1Tree<T> {
	...
	public function boudingBoxes():Iterator<Rj1TreeBoundingBox> {
		var cache = new List();
		var stack = new List();
